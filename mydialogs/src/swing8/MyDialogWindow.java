...
public class MyDialogWindow extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == m_btn) {
	     ...
	     "create new person" -->
	         show dialog and get id 
	         show dialog and get name
	         show dialog with cities: "tel-aviv, jerusalem, elat" use will choose one
	           *etgar: add icon of a map
	         create a person from this data
	      show dialog info (hitm: INFORMATION_MESSAGE) and print toString of the person
	    */    
